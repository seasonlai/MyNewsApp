...
import com.example.wellhope.mynewsapp.net.BaseObserver;
import com.example.wellhope.mynewsapp.net.NewsApi;
import com.example.wellhope.mynewsapp.net.NewsUtils;
...
public class DetailPresenter extends BasePresenter<DetailContract.View> implements DetailContract.Presenter {
    ...
    @Inject
    public DetailPresenter(NewsApi newsApi,DetailContract.View view) {
