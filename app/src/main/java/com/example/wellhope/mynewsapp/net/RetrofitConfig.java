...
import com.example.wellhope.mynewsapp.bean.Constants;
import com.example.wellhope.mynewsapp.utils.NetUtil;
...
public class RetrofitConfig {
    ...
    public static final Interceptor sLoggingInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            //打印url信息
            Log.w(TAG, "intercept: " + request.url() + (request.body() != null ?
